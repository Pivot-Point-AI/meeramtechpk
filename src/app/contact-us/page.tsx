    ...
    <>
      ...
      <main>
                ...
                <div className="mt-14 grid grid-cols-2 gap-x-6 gap-y-10 sm:gap-x-16 sm:gap-y-[48px] lg:mt-[129px]">
                  <div>
                    ...
                    <a
                      ...
                      className="mt-2 block text-[16px] leading-[30px] text-[#292929] sm:mt-[15px] sm:text-[18px]"
                    >
                      +9714 5297769
                    </a>
                  </div>
        ...
        <section className="mx-auto max-w-[1440px] px-6 pb-16 lg:px-[100px]">
          <div className="relative h-[300px] w-full overflow-hidden sm:h-[604px]">
            <Image
            ...
            <span
              aria-hidden
              className="absolute left-[44%] top-[42.5%] h-[26px] w-[26px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#0147FF] sm:h-[50px] sm:w-[50px]"
            />
          </div>
        </section>
      </main>
